...
import static kuhiep.resty.Utility.RestaurantUtils.hideSoftKeyboard;
...
public class BookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentCity = getIntent().getExtras().getString("city_name_book");
    ...
    public void fetchTimeAndUpdateUI(final boolean validateTime) {
        ...
        internetTime = new InternetTime(dateToFormat);
        // Got InternetTime
...
//        }
    ...
    public void addReservationToServer() {
        ...
        final DocumentReference documentReference = firebaseFirestore.collection("reservation").document();
        currentBooking.setReservationId(documentReference.getId());
        documentReference
                .set(currentBooking)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(intent);
                            Log.d("addReservationToServer", ":" + documentReference.getId());
                            ...
                            Log.d("addReservationToServer", "get failed with ", task.getException());
                        }
                    }
                });
