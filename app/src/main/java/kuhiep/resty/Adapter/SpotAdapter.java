...
import static kuhiep.resty.Utility.RestaurantUtils.BOOKINGS_CLOSED;
import static kuhiep.resty.Utility.RestaurantUtils.CLOSED_NOW;
import static kuhiep.resty.Utility.RestaurantUtils.CLOSING_SOON;

/**
 * Restaurant reservation android application on 12/21/17.
 */
...
public class SpotAdapter extends RecyclerView.Adapter<SpotAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.openStatus.setText(openStatus);
        holder.ratingBarText.setText(String.valueOf(rating) + "Rating");
